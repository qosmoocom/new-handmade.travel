...
const {createOne, getItem, getItems, updateOne, deleteOne,getItemByUser} = require('../controllers/tourController')
...
router.put('/byUser/:userID',protect, admin, moderator ,updateOne);
