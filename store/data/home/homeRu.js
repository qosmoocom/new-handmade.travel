export const home = {
  ...
  mission_text : {
    value : 'Handmade.travel объединяет путешественников нового поколения, ищущих оригинальности, аутентичности и самостоятельности. Наша главная задача - предоставить путешественнику возможность выбора: самостоятельно создать поездку своей мечты, либо выбрать свое идеальное путешествие из Библиотеки авторских туров.'
  },
  mission_ceo : {
  ...
  tours_title : {
    value : 'Библиотека авторских путешествий',
  },
  tours_comment : {
  ...
  utp_comment_short : {
    value : 'Потому что с нами мечта об идеальном путешествии становится реальностью.',
  },
  utp_list : {
    arr: [
      {
    ...
    arr: [
      {
        ...
        whatsapp : 'https://wa.me/998937201028'
      },
      {
      ...
      },
      {
        ...
        alt : 'Нарина-Ханум',
        telegram : 'https://t.me/Narina_HandMadeTravel',
        facebook : 'https://www.facebook.com/messages/t/100076587713633',
        whatsapp : 'https://wa.me/message/P4RSNJTWVSK2C1'
      },
      {
        ...
        whatsapp : 'https://wa.me/998937201032'
      },
      {
        ...
        facebook : 'https://www.facebook.com/messages/t/100071154707493',
        whatsapp : 'https://wa.me/message/OZVYJHI5QOLFJ1'
      },
      {
        name : 'Зокир Попович',
        info: 'Дуэйн "Скала" Джонсон команды handmade.travel, автор фото-экспедиций, организатор охот и рыбалок в Узбекистане. Обладатель узбекской звезды Michelin, Зокир не менее профессионален и компетентен в своей второй профессии.',
        ...
        whatsapp : 'https://wa.me/message/6Z6NXT5LH4I6J1'
      },
      {
        name : 'Сардорчик Палвончик',
        info: 'Главная няшка-скромняшка команды handmade.travel, Сардор - автор таких необычных туров как Астротур, "Rent Car Tour" и ещё кучи рекреационных поездок в Узбекистан. Ярый поклонник Испании, Сардор за 3 месяца выучил испанский язык и уверенно отбивает ритм фламенко.',
        src: '/images/home/authors/zokir.jpg',
        alt : 'Сардорчик Палвончик',
        telegram : 'https://t.me/handmadetravel_ru',
        facebook : 'https://www.facebook.com/messages/t/581402519012804/',
        whatsapp : 'https://wa.me/998937201028'
      },
  ...
  reviews_list : {
    arr: [
      {
        name :'Тур в Узбекистан на майские праздники',
        img: '/images/home/reviews/ru-1.jpg',
        text : "Если честно мы даже не ожидали, что Узбекистан произведет на нас такое впечатление. Все мы с детства и юности мечтали увидеть Бухару и Самарканд...",
        src: 'https://www.youtube.com/watch?v=L_u6B5a7hWE&t=4s',
        link : '#',
      },
      {
        name : 'Альфия, Альбина, Алина и Амир Темур в Узбекистане',
        img: '/images/home/reviews/ru-2.jpg',
        text : "Все прошло на высшем уровне! Были учтены все пожелания, был очень тонкий подход ко всему, действовали быстро и оперативно…",
        src: 'https://www.youtube.com/watch?v=wAc6-tTb2_M&t=4s',
        link : '#',
      },
      {
        name : 'Семья Полковых про свое путешествие в Узбекистан',
        img: '/images/home/reviews/ru-3.jpg',
        text : "Вопрос ехать или не не ехать в Узбекистан, тут просто не стоит. Конечно, ехать! Потому что страна красивая, страна древняя, города - ровесники Рима...",
        src: 'https://www.youtube.com/watch?v=3XtFctguxgQ&t=4s',
        link : '#',
      },
      {
        name : 'Наталия и Кристиан об Узбекистане',
        img: '/images/home/reviews/ru-4.jpg',
        text : "В общем, были сомнения, которые развеялись сразу же, как только мы приехали в Узбекистан. Ситуация была совершенно иная, все было организовано...",
        src: 'https://www.youtube.com/watch?v=KjyKHUJGusk&t=4s',
        link : '#',
      },
    ]
  },
  ...
  blogs_comment : {
    value : 'Handmadeburg - это travel-блог для охотников за путешествиями. Полезные статьи, советы и лайфхаки по самостоятельной поездки от заядлых путешественников и локальных блогеров. Вдохновляйтесь и начинайте паковать чемоданы и собирать рюкзаки!',
  },
  blogs_comment_short : {
    value : 'Handmadeburg - это travel блог для охотников за путешествиями. Полезные статьи, советы и лайфхаки по самостоятельной поездке от локальных блогеров.',
  },
  blogs_button_title : {
    value: 'Показать программу'
  },
  ...
  footer_links : {
    arr : [
      ...
      },
      {
        ...
        alt : 'youtube',
        link: "hhttps://www.youtube.com/playlist?list=PLnMxvgxCXwy_FJPKR03NaYzj7sN0gEalD",
      }
    ]
  },
}