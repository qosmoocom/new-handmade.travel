export const home = {
  ...
  header_general_title :{
    value : 'Tour to Uzbekistan with our own hands'
  },
  header_button_title :{
    value : 'Create your tour'
  },
  mission_title : {
    value : 'Our conception',
  },
  mission_comment : {
  ...
  mission_text : {
    value : `Handmade.travel unites a new generation of travelers looking for originality, authenticity and individuality. Our main task is to give the traveler a choice: to create his dream trip on his own, or to choose his perfect trip from the library of author's tours.`
  },
  mission_ceo : {
  ...
  tours_title : {
    value : 'Ideas for your travels',
  },
  tours_comment : {
    value : `Original programs and unconventional routes for those who are not afraid to try new things in life. Don't limit yourself to an idea... Make it happen!`,
  },
  tours_comment_short : {
    value : `Original programs and unconventional routes for those who are not afraid to try new things in life. Don't limit yourself to an idea... Make it happen!`,
  },
  ...
  utp_title : {
    value : 'Why handmade.travel?',
  },
  utp_comment : {
    value : 'Because with us, the dream of a perfect trip becomes reality, the unattainable becomes attainable, and the unattainable becomes achievable!',
  },
  utp_comment_short : {
    value : 'Because with us, the dream of a perfect trip becomes reality, the unattainable becomes attainable, and the unattainable becomes achievable!',
  },
  ...
  authors_comment : {
    value : 'Handmade.travel team is young, energetic and creative guys with international experience. Our tour creators know everything about your trip to Uzbekistan and a little bit more.',
  },
  ...
  blogs_comment : {
    value : 'Handmadeburg - is a travel blog for travel hunters. Helpful articles, tips, and travel tips on independent travel from local bloggers. Get inspired and start backpacking!',
  },
  blogs_comment_short : {
    value : 'Handmadeburg - is a travel blog for travel hunters. Helpful articles, tips, and travel tips on independent travel from local bloggers. Get inspired and start backpacking!',
  },
  ...
  footer_info_text : {
    value : `trademark Silk Road Destinations. We have 20 years' experience in the travel industry. More than 35,000 satisfied tourists. More than 100 video reviews. Winner of  To Do 2014.`
  },
  footer_payment : {
    arr : [
      { 
  ...
  footer_service_list : {
    arr : [
      ...
      {
        name : 'Guaranteed departure tours',
        link : '#'
      },
      {
        name : 'Combi tours',
