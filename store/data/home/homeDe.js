export const home = {
    ...
    arr: [
      {
        ...
        link: 'https://www.facebook.com/messages/t/100076785810304/',
        alt : 'facebook'
      },
      {
        name : 'telegram',
        src: '/images/home/header/ico/telegram.svg',
        link: 'https://t.me/handmadetravelde',
        alt : 'telegram'
      },
      {
        name : 'whatsapp',
        src: '/images/home/header/ico/whatsapp.svg',
        link: 'https://wa.me/998937201032',
        alt : 'whatsapp'
      },
    ]
  },
  header_general_title :{
    value : 'Reise nach Usbekistan mit eigenen Händen'
  },
  header_button_title :{
    value : 'Eigene Tour erstellen'
  },
  mission_title : {
    value : 'UNSER KONZEPT',
  },
  ...
  mission_text : {
    value : 'Handmade.travel bringt eine neue Generation von Reisenden zusammen, die nach Originalität, Authentizität und Unabhängigkeit suchen. Unsere Hauptaufgabe ist es, dem Reisenden die Wahl zu lassen: seine eigene Traumreise zu erstellen oder seine ideale Reise aus der Reisebibliothek des Erstellers zu finden.'
  },
  mission_ceo : {
  ...
  tours_title : {
    value : 'Einzigartige Ideen der Autorin für Ihre Reisen',
  },
  tours_comment : {
    value : 'Kreative Programme und außergewöhnliche Reiserouten für alle, die sich nicht scheuen, neue Dinge im Leben auszuprobieren. Beschränken Sie sich nicht auf eine Idee... Machen Sie es möglich!',
  },
  tours_comment_short : {
    value : 'Kreative Programme und außergewöhnliche Reiserouten für alle, die sich nicht scheuen, neue Dinge im Leben auszuprobieren. Beschränken Sie sich nicht auf eine Idee... Machen Sie es möglich!',
  },
  tours_button_title : {
    value: 'Programm anzeigen'
  },
  tours_view_more_text : {
    value : 'mehr anzeigen'
  },
  utp_title : {
    value : 'Warum handmade.travel?',
  },
  utp_comment : {
    value : 'Denn mit uns wird der Traum von der perfekten Reise Wirklichkeit, das Unerreichbare wird erreichbar und das Unerfüllbare wird machbar! ',
  },
  utp_comment_short : {
    value : 'Denn mit uns wird der Traum von der perfekten Reise Wirklichkeit, das Unerreichbare wird erreichbar und das Unerfüllbare wird machbar! ',
  },
  ...
  authors_title : {
    value : 'Lokale Reiseexperten',
  },
  authors_comment : {
    value : 'Das handmade.travel Team sind junge, energiegeladene und kreative Leute mit internationaler Erfahrung. Unsere Reiseorganisatoren wissen alles über Ihre Reise nach Usbekistan und noch ein bisschen mehr.',
  },
  authors_comment_short : {
    value : 'Das handmade.travel Team sind junge, energiegeladene und kreative Leute mit internationaler Erfahrung. Unsere Reiseorganisatoren wissen alles über Ihre Reise nach Usbekistan und noch ein bisschen mehr.',
  },
  authors_button_link : {
    value : 'an den Organisator schreiben',
  },
  authors_list : {
    arr: [
      {
      ...
      },
      {
        ...
        alt : 'Narina',
        telegram : 'https://t.me/handmadetravelde',
        facebook : 'hhttps://www.facebook.com/messages/t/100076785810304/',
        whatsapp : 'https://wa.me/998937201032'
      },
      {
        name : 'Saidxon',
      ...
      {
        name : 'Sardor',
        info: 'Sardor, ein beliebtes Mitglied des handmade.travel-Teams, ist der Gestalter von ungewöhnlichen Touren wie Astrotour, Rent Car Tour und vielen weiteren Erlebnisreisen nach Usbekistan. Als begeisterter Spanien-Fan hat Sardor in 3 Monaten Spanisch gelernt und entwickelt sich tüchtig bei Flamenco-Tanz.',
  ...
  reviews_title : {
    value : 'Feedback von unseren Reisenden. Echte Feedbacks und Videobewertungen',
  },
  reviews_comment : {
    value : '97 % unserer Gäste sind mit unserem Preis-Leistungs-Verhältnis rundum zufrieden, 98 % empfehlen uns an Freunde und Bekannte weiter und 99 % unserer Reisenden bewerten unsere Reiseprogramme mit 10 von 10 Punkten.',
  },
  ...
  blogs_comment : {
    value : 'Handmadeburg - ist ein Reiseblog für Reiselustige. Hilfreiche Artikel, Tipps und Tricks zum unabhängigen Reisen von lokalen Bloggern. Lassen Sie sich inspirieren und packen Sie Ihre Koffer!',
  },
  blogs_comment_short : {
    value : 'Handmadeburg - ist ein Reiseblog für Reiselustige. Hilfreiche Artikel, Tipps und Tricks zum unabhängigen Reisen von lokalen Bloggern. Lassen Sie sich inspirieren und packen Sie Ihre Koffer!',
  },
  ...
  footer_info_text : {
    arr : [
      ...
      {value : 'Seit 2004 im Geschäft'},
      {value : '20.000+ organisierte Touren'},
      {value : '34.850 glückliche Touristen'},
      {value : 'Über 100 Videobewertungen'},
    ]
  },
  footer_payment : {
    arr : [
  ...
  footer_contacts_mail : {
    value : 'german@handmade.travel'
  },
  footer_contacts_adress_1 : {
    value : 'Kuk Sarai Platz 1'
  },
  footer_contacts_adress_2 : {
    value : 'Samarkand, 140157, Usbekistan'
  },
  ...
  footer_service_title : {
    value : 'Unsere Leistungen:'
  },
  footer_service_list : {
    arr : [
      {
        name : 'Individuelle Touren',
        link : '#'
      },
      {
        name : 'Maßgeschneiderte Touren',
        link : '#'
      },
      {
        name : 'Garantierte Touren',
        link : '#'
      },
      {
        name : 'Kombinierte Touren',
        link : '#'
      },
      {
        name : 'MICE-Tourismus',
      ...
      {
        name : 'Verantwortungsvoller Tourismus',
        link : '#'
      },
    ]
  },
  footer_company_title : {
    value : 'Nützliche Hinweise:'
  },
  footer_company_list : {
    arr : [
      {
    ...
    arr : [
      {
        ...
        alt : 'facebook',
        link: "https://www.facebook.com/SilkRoadDestinationsde",
      },
      {
        src : '/images/home/footer/insta.png',
        alt : 'instagram',
        link: "#https://www.instagram.com/reiseinusbekistan/",
      },
      {
        src : '/images/home/footer/youtube.png',
        alt : 'youtube',
        link: "https://www.youtube.com/playlist?list=PLnMxvgxCXwy-LhFUFA8OEM_O_uydd6Nue",
      }
    ]
  },
}